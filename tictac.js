...
board.addEventListener('click', function(event){
	...
	if(clickedBox!=='' && turn%2===0 && whoesTurn==='X'){
		...
		turn= turn+1;
	}else if(clickedBox!=='' && !turn%2 === 0  && whoesTurn=== 'X'){
